...
let game = {
    ...
    loaddata(){
        ...
        this.plansza[x].push(new Plansza("You are in a shoemaker's house", "57.gif", "rgb(254,194,97)",[`NORTH`],[],x,6,[this.items[11],this.items[14],this.items[24]],["You used your tools to make a rag","You prepared a solid poison","You used your tools to make shoes"]));
        //6
        x++;
        this.plansza[x].push(0);
        this.plansza[x].push(0);
    ...
    move(){
        ...
        if(this.kierunki.includes(this.input)){
            if(this.plansza[this.current_location.posy][this.current_location.posx].directions.includes(this.input)){
                console.log(this.plansza[this.current_location.posy][this.current_location.posx].przejscie);
                switch(this.input) {
                    case "EAST":
            ...
            else if(game.player.item.id == 36){
                game.ending();
            }

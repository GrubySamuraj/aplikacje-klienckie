...
class Ui {
    ...
    lost = () => {
        console.log("lost");
        if (document.getElementById("wait_info"))
            document.getElementById("wait_info").remove();
        this.okienko = document.createElement("div");
        this.okienko.setAttribute("id", "wait_info");
        this.okienko.innerText = `Przegrałeś/aś, wygrany użytkownik to ${net.user.przeciwnik}`;
        document.getElementById("status").innerText = `Przegrałeś! ${net.user.nazwa}, ${net.user.przeciwnik} okazał się lepszy!`;
        document.getElementsByTagName("body")[0].appendChild(this.okienko);
    }
    win = () => {
        console.log("win");
        ...
        this.okienko = document.createElement("div");
        this.okienko.setAttribute("id", "wait_info");
        this.okienko.innerText = `Brawo! ${net.user.nazwa}, Wygrałeś/aś z ${net.user.przeciwnik}`;
        document.getElementById("status").innerText = `Wygrałeś! ${net.user.nazwa}, Gratulacje!`;
        document.getElementsByTagName("body")[0].appendChild(this.okienko);
    }
}